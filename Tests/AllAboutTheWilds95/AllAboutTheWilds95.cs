...
namespace PlaywrightTests.Tests.AllAboutTheWilds95
{
    [TestFixture]
    public class AllAboutTheWilds95 : BasePlaywrightTest
    {
        [Test]
        [Category("Game")]
        ...
        {
            var stake = 5;
            await Navigate(PlaywrightHelpers.GetGameUrl(GameType.AllAboutTheWilds95));
